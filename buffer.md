...
```mermaid
flowchart TB
    A[1. Créer un dossier] --> B[2. Remplir formulaire structuré\n(faits, moyens, objectifs)]
    B --> C[3. Générer plan standard\n(bouton "Proposer un plan")]
    C --> D[4. Afficher/ajuster plan\n(checkbox pour sections)]
    D --> E[5. Générer brouillon\n(bouton "Générer le mémoire")]
    E --> F[6. Relecture & édition\n(éditeur texte)]
